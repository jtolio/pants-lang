...
public:
  ...
  void testSingleLists() {
    ...
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    CPPUNIT_ASSERT(exps[0]->format() == "Application(Term(Value(Function(Left(Required(RequiredInArgument(Variable(a, user_provided))), Optional()), Right(Required(), Optional()), Expressions(Application(Term(Value(Variable(null, user_provided)), Trailers()))))), Trailers()))");
    exps.clear();
    CPPUNIT_ASSERT(cirth::parser::parse("{|b,| null}", exps));
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    CPPUNIT_ASSERT(exps[0]->format() == "Application(Term(Value(Function(Left(Required(), Optional()), Right(Required(RequiredInArgument(Variable(b, user_provided))), Optional()), Expressions(Application(Term(Value(Variable(null, user_provided)), Trailers()))))), Trailers()))");
  }
  ...
  void testFunctions() {
    ...
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    CPPUNIT_ASSERT(exps[0]->format() == "Application(Term(Value(Function(Left(Required(), Optional()), Right(Required(), Optional()), Expressions(Application(Term(Value(Variable(null, user_provided)), Trailers()))))), Trailers()))");
    exps.clear();
    CPPUNIT_ASSERT(cirth::parser::parse("{{thing1:thing2}}", exps));
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    CPPUNIT_ASSERT(exps[0]->format() == "Application(Term(Value(Function(Left(Required(), Optional()), Right(Required(), Optional()), Expressions(Application(Term(Value(Dictionary(DictDefinition(Application(Term(Value(Variable(thing1, user_provided)), Trailers())), Application(Term(Value(Variable(thing2, user_provided)), Trailers()))))), Trailers()))))), Trailers()))");
    exps.clear();
    CPPUNIT_ASSERT(cirth::parser::parse("{|a| print(\"hi\"); null}", exps));
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    CPPUNIT_ASSERT(exps[0]->format() == "Application(Term(Value(Function(Left(Required(), Optional()), Right(Required(RequiredInArgument(Variable(a, user_provided))), Optional()), Expressions(Application(Term(Value(Variable(print, user_provided)), Trailers(ClosedCall(Left(), Right(RequiredOutArgument(Application(Term(Value(CharString(hi)), Trailers())))), Scoped())))), Application(Term(Value(Variable(null, user_provided)), Trailers()))))), Trailers()))");
    exps.clear();
    CPPUNIT_ASSERT(cirth::parser::parse("{|a,| null}", exps));
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    CPPUNIT_ASSERT(exps[0]->format() == "Application(Term(Value(Function(Left(Required(), Optional()), Right(Required(RequiredInArgument(Variable(a, user_provided))), Optional()), Expressions(Application(Term(Value(Variable(null, user_provided)), Trailers()))))), Trailers()))");
    exps.clear();
    CPPUNIT_ASSERT(cirth::parser::parse("{|a,b| 0}", exps));
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    CPPUNIT_ASSERT(exps[0]->format() == "Application(Term(Value(Function(Left(Required(), Optional()), Right(Required(RequiredInArgument(Variable(a, user_provided)), RequiredInArgument(Variable(b, user_provided))), Optional()), Expressions(Application(Term(Value(Integer(0)), Trailers()))))), Trailers()))");
    exps.clear();
    CPPUNIT_ASSERT(cirth::parser::parse("{|a,b,| 0}", exps));
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    ...
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    CPPUNIT_ASSERT(exps[0]->format() == "Application(Term(Value(Function(Left(Required(), Optional()), Right(Required(RequiredInArgument(Variable(a, user_provided)), RequiredInArgument(Variable(b, user_provided))), Optional(OptionalInArgument(Variable(c, user_provided), Application(Term(Value(Integer(3)), Trailers()))))), Expressions(Application(Term(Value(Integer(0)), Trailers()))))), Trailers()))");
    exps.clear();
    CPPUNIT_ASSERT(cirth::parser::parse("{|a,b,c:3,d:4| 0}", exps));
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    CPPUNIT_ASSERT(exps[0]->format() == "Application(Term(Value(Function(Left(Required(), Optional()), Right(Required(RequiredInArgument(Variable(a, user_provided)), RequiredInArgument(Variable(b, user_provided))), Optional(OptionalInArgument(Variable(c, user_provided), Application(Term(Value(Integer(3)), Trailers()))), OptionalInArgument(Variable(d, user_provided), Application(Term(Value(Integer(4)), Trailers()))))), Expressions(Application(Term(Value(Integer(0)), Trailers()))))), Trailers()))");
    exps.clear();
    CPPUNIT_ASSERT(cirth::parser::parse("{|a,b,c:3,d:4,*(opt)| 0}", exps));
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    CPPUNIT_ASSERT(exps[0]->format() == "Application(Term(Value(Function(Left(Required(), Optional()), Right(Required(RequiredInArgument(Variable(a, user_provided)), RequiredInArgument(Variable(b, user_provided))), Optional(OptionalInArgument(Variable(c, user_provided), Application(Term(Value(Integer(3)), Trailers()))), OptionalInArgument(Variable(d, user_provided), Application(Term(Value(Integer(4)), Trailers())))), Arbitrary(Variable(opt, user_provided))), Expressions(Application(Term(Value(Integer(0)), Trailers()))))), Trailers()))");
    exps.clear();
    ...
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    CPPUNIT_ASSERT(exps[0]->format() == "Application(Term(Value(Function(Left(Required(), Optional()), Right(Required(), Optional()), Expressions(Application(Term(Value(Integer(0)), Trailers()))))), Trailers()))");
    exps.clear();
    CPPUNIT_ASSERT(cirth::parser::parse("{|;| 0}", exps));
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    ...
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    CPPUNIT_ASSERT(exps[0]->format() == "Application(Term(Value(Function(Left(Required(RequiredInArgument(Variable(a, user_provided))), Optional()), Right(Required(), Optional()), Expressions(Application(Term(Value(Integer(0)), Trailers()))))), Trailers()))");
    exps.clear();
    CPPUNIT_ASSERT(cirth::parser::parse("{|a,b;| 0}", exps));
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    CPPUNIT_ASSERT(exps[0]->format() == "Application(Term(Value(Function(Left(Required(RequiredInArgument(Variable(a, user_provided)), RequiredInArgument(Variable(b, user_provided))), Optional()), Right(Required(), Optional()), Expressions(Application(Term(Value(Integer(0)), Trailers()))))), Trailers()))");
    exps.clear();
    CPPUNIT_ASSERT(cirth::parser::parse("{|a,b,;| 0}", exps));
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    ...
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    CPPUNIT_ASSERT(exps[0]->format() == "Application(Term(Value(Function(Left(Required(RequiredInArgument(Variable(a, user_provided)), RequiredInArgument(Variable(b, user_provided))), Optional(OptionalInArgument(Variable(c, user_provided), Application(Term(Value(Integer(3)), Trailers()))))), Right(Required(), Optional()), Expressions(Application(Term(Value(Integer(0)), Trailers()))))), Trailers()))");
    exps.clear();
    CPPUNIT_ASSERT(cirth::parser::parse("{|*(var),c:3,a,b,;| 0}", exps));
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    CPPUNIT_ASSERT(exps[0]->format() == "Application(Term(Value(Function(Left(Required(RequiredInArgument(Variable(a, user_provided)), RequiredInArgument(Variable(b, user_provided))), Optional(OptionalInArgument(Variable(c, user_provided), Application(Term(Value(Integer(3)), Trailers())))), Arbitrary(Variable(var, user_provided))), Right(Required(), Optional()), Expressions(Application(Term(Value(Integer(0)), Trailers()))))), Trailers()))");
    exps.clear();
    CPPUNIT_ASSERT(cirth::parser::parse("{|*(var),c:3,a,b,d;e,f,g:5,h:7,*(j)| 0}", exps));
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    CPPUNIT_ASSERT(exps[0]->format() == "Application(Term(Value(Function(Left(Required(RequiredInArgument(Variable(a, user_provided)), RequiredInArgument(Variable(b, user_provided)), RequiredInArgument(Variable(d, user_provided))), Optional(OptionalInArgument(Variable(c, user_provided), Application(Term(Value(Integer(3)), Trailers())))), Arbitrary(Variable(var, user_provided))), Right(Required(RequiredInArgument(Variable(e, user_provided)), RequiredInArgument(Variable(f, user_provided))), Optional(OptionalInArgument(Variable(g, user_provided), Application(Term(Value(Integer(5)), Trailers()))), OptionalInArgument(Variable(h, user_provided), Application(Term(Value(Integer(7)), Trailers())))), Arbitrary(Variable(j, user_provided))), Expressions(Application(Term(Value(Integer(0)), Trailers()))))), Trailers()))");
    exps.clear();
    CPPUNIT_ASSERT(cirth::parser::parse("{|*(a);*(b)| 0}", exps));
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    CPPUNIT_ASSERT(exps[0]->format() == "Application(Term(Value(Function(Left(Required(), Optional(), Arbitrary(Variable(a, user_provided))), Right(Required(), Optional(), Arbitrary(Variable(b, user_provided))), Expressions(Application(Term(Value(Integer(0)), Trailers()))))), Trailers()))");
    exps.clear();
    CPPUNIT_ASSERT(cirth::parser::parse("{|**(a);**(b)| 0}", exps));
    CPPUNIT_ASSERT(exps.size() == 1);
    CPPUNIT_ASSERT(exps[0].get());
    CPPUNIT_ASSERT(exps[0]->format() == "Application(Term(Value(Function(Left(Required(), Optional(), Keyword(Variable(a, user_provided))), Right(Required(), Optional(), Keyword(Variable(b, user_provided))), Expressions(Application(Term(Value(Integer(0)), Trailers()))))), Trailers()))");
  }
